...
// el	void updateBidiLevel(FriBidiLevel bidiLevel);
...
// el 	FriBidiCharType myBidiCharType;
	ZLUnicodeUtil::Ucs4String myUcs4String;
// el	std::vector<FriBidiLevel> myBidiLevels;
// el	const FriBidiLevel myBaseBidiLevel;
// el	FriBidiLevel myCurrentBidiLevel;
// el	FriBidiLevel myLatestBidiLevel;
};
