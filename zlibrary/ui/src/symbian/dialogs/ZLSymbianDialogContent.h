...
#ifndef __ZLSYMBIANDIALOGCONTENT_H__
#define __ZLSYMBIANDIALOGCONTENT_H__
...
class ZLSymbianDialogContent : public ZLDialogContent, public ZLSymbianOptionViewHolder {

public:
	ZLSymbianDialogContent(const ZLResource &resource);
	~ZLSymbianDialogContent();
...
inline ZLSymbianDialogContent::Position::Position(int row, int fromColumn, int toColumn) : Row(row), FromColumn(fromColumn), ToColumn(toColumn) {}

#endif /* __ZLSYMBIANDIALOGCONTENT_H__ */
