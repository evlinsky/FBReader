...
#include "../time/ZLSymbianTime.h"
//#include "../dialogs/ZLSymbianDialogManager.h"
//#include "../../gtk/image/ZLGtkImageManager.h"
//#include "../view/ZLSymbianPaintContext.h"
//#include "../message/ZLSymbianMessage.h"
//#include "../../../../core/src/unix/xmlconfig/XMLConfig.h"
//#include "../../../../core/src/unix/iconv/IConvEncodingConverter.h"
//#if MAEMO_VERSION > 2
//#include "../network/ZLSymbianNetworkManager.h"
//#endif

class ZLSymbianLibraryImplementation : public ZLibraryImplementation {
private:
...
void initLibrary() {
/*	new ZLSymbianLibraryImplementation();*/
}

void ZLSymbianLibraryImplementation::init(int &argc, char **&argv) {
/*	gtk_init(&argc, &argv);
...
ZLPaintContext *ZLSymbianLibraryImplementation::createContext() {
/*	return new ZLSymbianPaintContext();*/return NULL;
}

void ZLSymbianLibraryImplementation::run(ZLApplication *application) {
...
LOCAL_C CApaApplication* NewApplication()
	{
	return new CfbreaderApplication;
	}
