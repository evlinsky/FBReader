...
#ifndef __ZLSYMBIANNETWORKMANAGER_H__
#define __ZLSYMBIANNETWORKMANAGER_H__

//#include <conic.h>

#include "../../../../core/src/unix/curl/ZLCurlNetworkManager.h"

class ZLSymbianNetworkManager : public ZLCurlNetworkManager {

public:
	static void createInstance();

private:
	ZLSymbianNetworkManager();
	~ZLSymbianNetworkManager();
...
#endif /* __ZLSYMBIANNETWORKMANAGER_H__ */
