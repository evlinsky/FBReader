...
#include "ZLSymbianOptionViewHolder.h"
#include "ZLSymbianOptionView.h"

ZLOptionView *ZLSymbianOptionViewHolder::createViewByEntry(const std::string &name, const std::string &tooltip, shared_ptr<ZLOptionEntry> option) {
/*	if (option.isNull()) {
		return 0;
	}
