...
#ifndef __ZLSYMBIANPAINTCONTEXT_H__
#define __ZLSYMBIANPAINTCONTEXT_H__
...
class ZLSymbianPaintContext : public ZLPaintContext {

public:
	ZLSymbianPaintContext();
	~ZLSymbianPaintContext();
...
#endif /* __ZLSYMBIANPAINTCONTEXT_H__ */
