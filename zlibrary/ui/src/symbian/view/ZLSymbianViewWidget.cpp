...
#include "ZLSymbianViewWidget.h"
#include "ZLSymbianPaintContext.h"
...
CZLSymbianAppView* CZLSymbianAppView::NewL(const TRect& aRect) {
	CZLSymbianAppView* self = CZLSymbianAppView::NewLC(aRect);
	CleanupStack::Pop(self);
	return self;
}

CZLSymbianAppView* CZLSymbianAppView::NewLC(const TRect& aRect) {
	CZLSymbianAppView* self = new (ELeave) CZLSymbianAppView;
	CleanupStack::PushL(self);
	self->ConstructL(aRect);
	return self;
}

void CZLSymbianAppView::ConstructL(const TRect& aRect) {
	CreateWindowL();
	SetRect(aRect);
	ActivateL();
}

CZLSymbianAppView::CZLSymbianAppView() {
...
void CZLSymbianAppView::Draw(const TRect& aRec) const {
...
void CZLSymbianAppView::SizeChanged() {
	DrawNow();
}

void CZLSymbianAppView::HandlePointerEventL(const TPointerEvent& aPointerEvent) {
...
void ZLSymbianViewWidget::updateCoordinates(int &x, int &y) {
/*	switch (rotation()) {
		default:
			break;
...
/*
bool ZLSymbianViewWidget::isStylusEvent(GtkWidget *widget, GdkEventButton *event) {
#if MAEMO_VERSION <= 3
	if (event->button == 8) {
		return false;
	}
...
*//*
void ZLSymbianViewWidget::onMousePressed(GdkEventButton *event) {
	int x = (int)event->x;
	int y = (int)event->y;
...
*//*
void ZLSymbianViewWidget::onMouseReleased(GdkEventButton *event) {
/*	if (isStylusEvent(myArea, event)) {
		int x = (int)event->x;
		int y = (int)event->y;
		updateCoordinates(x, y);
...
*//*
void ZLSymbianViewWidget::onMouseMoved(GdkEventMotion *event) {
	int x, y;
...
*/
int ZLSymbianViewWidget::width() const {
/*	return (myArea != 0) ? myArea->allocation.width : 0;*/return 0;
}

int ZLSymbianViewWidget::height() const {
/*	return (myArea != 0) ? myArea->allocation.height : 0;*/return 0;
}

static const std::string GROUP = "StylusPressure";
/*
bool ZLSymbianViewWidget::scrollbarEvent(ZLView::Direction direction, GtkRange *range, GtkScrollType type, double newValue) {
...
*//*
GtkWidget *ZLSymbianViewWidget::createVScrollbar(int pos) {
...
*//*
GtkWidget *ZLSymbianViewWidget::createHScrollbar(int pos) {
...
*/
ZLSymbianViewWidget::ZLSymbianViewWidget(ZLApplication *application, ZLView::Angle initialAngle) :
...
void ZLSymbianViewWidget::setScrollbarEnabled(ZLView::Direction direction, bool enabled) {
...
void ZLSymbianViewWidget::setScrollbarPlacement(ZLView::Direction direction, bool standard) {
...
void ZLSymbianViewWidget::setScrollbarParameters(ZLView::Direction direction, size_t full, size_t from, size_t to) {
...
ZLSymbianViewWidget::~ZLSymbianViewWidget() {
/*	cleanOriginalPixbuf();
	cleanRotatedPixbuf();*/
}

void ZLSymbianViewWidget::cleanOriginalPixbuf() {
...
void ZLSymbianViewWidget::cleanRotatedPixbuf() {
...
void ZLSymbianViewWidget::trackStylus(bool track) {
	// TODO: implement
}

void ZLSymbianViewWidget::repaint()	{
/*	gtk_widget_queue_draw(myArea);*/
}

void ZLSymbianViewWidget::doPaint()	{
...
/*
GtkWidget *ZLSymbianViewWidget::area() {
	return myArea;
}
*//*
GtkWidget *ZLSymbianViewWidget::areaWithScrollbars() {
