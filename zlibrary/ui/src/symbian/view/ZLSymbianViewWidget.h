...
#ifndef __ZLSYMBIANVIEWWIDGET_H__
#define __ZLSYMBIANVIEWWIDGET_H__
...
class CfbreaderAppView : public CCoeControl {
public:
	static CfbreaderAppView* NewL(const TRect& aRect);
	static CfbreaderAppView* NewLC(const TRect& aRect);
	virtual ~CfbreaderAppView();
...
class ZLSymbianSpecificOptions;

class ZLSymbianViewWidget : public ZLViewWidget {
...
public:
	ZLSymbianViewWidget(ZLApplication *application, ZLView::Angle initialAngle);
	~ZLSymbianViewWidget();
...
//	GtkWidget *myTopScrollBar;
	...
	ZLSymbianSpecificOptions *mySpecificOptions;
};

#endif /* __ZLSYMBIANVIEWWIDGET_H__ */
